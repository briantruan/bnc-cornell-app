export function NewBadge() {
    return (
        <div className="badge bg-warning text-black uppercase">New</div>
    )
}

export function UpdatedBadge({options}) {
    return (
        <div className={`badge badge-lg gap-2 bg-success text-base-100 uppercase tooltip`} data-tip={options}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-from-line inline-block"><path d="m18 9-6-6-6 6"/><path d="M12 3v14"/><path d="M5 21h14"/></svg>
        </div>
    )
}
...
export function AlertBadge() {
    return (
        <div className="badge bg-warning text-black uppercase">!</div>
    )
}

export function FoodBadge() {
    return (
        <button className="btn btn-xs btn-primary no-animation tooltip" data-tip="Food Security">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-soup"><path d="M12 21a9 9 0 0 0 9-9H3a9 9 0 0 0 9 9Z"/><path d="M7 21h10"/><path d="M19.5 12 22 6"/><path d="M16.25 3c.27.1.8.53.75 1.36-.06.83-.93 1.2-1 2.02-.05.78.34 1.24.73 1.62"/><path d="M11.25 3c.27.1.8.53.74 1.36-.05.83-.93 1.2-.98 2.02-.06.78.33 1.24.72 1.62"/><path d="M6.25 3c.27.1.8.53.75 1.36-.06.83-.93 1.2-1 2.02-.05.78.34 1.24.74 1.62"/></svg>
        </button>
    )
}

export function HousingBadge() {
    return (
        <button className="btn btn-xs btn-primary no-animation tooltip" data-tip="Housing">
...
export function HealthBadge() {
    return (
        <button className="btn btn-xs btn-primary no-animation tooltip" data-tip="Health and Wellness">
...
export function IntlBadge() {
    return (
        <button className="btn btn-xs btn-primary no-animation tooltip" data-tip="International Students">
...
export function TransportBadge() {
    return (
        <button className="btn btn-xs btn-primary no-animation tooltip" data-tip="Transportation">
...
export function FinancialsBadge() {
    return (
        <button className="btn btn-xs btn-primary no-animation tooltip" data-tip="Financials">
