    ...
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-70 h-full bg-base-200 text-base-content">
          ...
          <SidebarOption link="/" text="Cornell Basic Needs" options="uppercase" />
          ...
          {/* Replace announcement svg with megaphone */}

          {/* <AnnouncementSidebarItem /> */}

          <SidebarOption link="/about" text="About Us"
            svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-info"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>}
          />

          <SidebarOption link="/get-involved" text="Get Involved"
            svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-merge"><path d="m8 6 4-4 4 4"/><path d="M12 2v10.3a4 4 0 0 1-1.172 2.872L4 22"/><path d="m20 22-5-5"/></svg>}
          />

          <SidebarOption link="/guides" text="Access Guides" options="lg:grow"
          ...
          <li>
            <footer className="footer items-center px-4 text-neutral-content">
              <div className="items-center grid-flow-col">
                <p>© 2023 | <Link href={"/studio"}>Portal</Link></p>
              </div>
              <div className="grid-flow-col gap-2 md:place-self-center md:justify-self-end">
                <button className="btn btn-square">
                  <Link href="https://instagram.com/cornellbasicneeds" target="_blank">
